package com.thebombzen.zengifr;
...
public final class ZenGIFr {
	 ...
	 * identifier is written to a file on start. Zen GIFr checks the
	...
	/**
	 * Print help and exit, useful if Zen GIFr was invoked from the command
	 * line.
	 * 
	 * @param good
	...
	private static void printHelpAndExit(boolean good) {
		System.out.println("zengifr\t--help");
		System.out.println("zengifr\t[filename]");
		System.exit(good ? 0 : 1);
	}

	/**
	 * Clean up the mess left behind by old versions of Zen GIFr.
	 * 
