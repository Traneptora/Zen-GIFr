...
public class MainFrame extends JFrame {
	...
	public MainFrame() {
		...
		mainFrame = this;
		setTitle("Zen GIFr: Version " + ZenGIFr.VERSION);
		...
		quit.addActionListener(ae -> ZenGIFr.quit());
				...
				switch (e.getKeyCode()) {
					case KeyEvent.VK_Q:
						if (e.isControlDown() && !e.isShiftDown()) {
							ConcurrenceManager.executeLater(ZenGIFr::quit);
							return true;
						}
						break;
					case KeyEvent.VK_O:
		...
		ConcurrenceManager.addPostInitTask(new DefaultTask(-50, () -> {
			ZenGIFr.executeOldVersionCleanup();
