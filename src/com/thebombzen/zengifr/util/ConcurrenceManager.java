...
import com.thebombzen.zengifr.util.io.NullInputStream;
import com.thebombzen.zengifr.util.io.NullOutputStream;
...
public final class ConcurrenceManager {
		...
		try {
			if (join) {
				...
				if (doLog) {
					...
					ZenGIFr.getLogFileOutputStream().write(bout.toByteArray());
					ZenGIFr.getLogFileOutputStream().flush();
					return in;
				} else {
	...
	private static void cleanUp() {
		...
		IOHelper.closeQuietly(ZenGIFr.getLogFileOutputStream());
	}
